...
(define-private (concat-list (dummy (list 20 uint)) (final (list 1500 uint)))
  (unwrap-panic (as-max-len? (concat final dummy) u1500))
)
  ...
  (begin 
    (match (map-get? id-to-participant id)
      temp-tuple (if (is-eq (/ (get value temp-tuple) u1000) u0)
        (list )
        (if (is-eq (/ (get value temp-tuple) u100) u1)
          (list id)
          (if (is-eq (/ (get value temp-tuple) u100) u2)
            (list id id)
            (if (is-eq (/ (get value temp-tuple) u100) u3)
              (list id id id)
              (if (is-eq (/ (get value temp-tuple) u100) u4)
                (list id id id id)
                (if (is-eq (/ (get value temp-tuple) u100) u5)
                  (list id id id id id)
                  (if (is-eq (/ (get value temp-tuple) u100) u6)
                    (list id id id id id id)
                    (if (is-eq (/ (get value temp-tuple) u1000) u7)
                      (list id id id id id id id)
                      (if (is-eq (/ (get value temp-tuple) u100) u8)
                        (list id id id id id id id id)
                        (if (is-eq (/ (get value temp-tuple) u100) u9)
                          (list id id id id id id id id id)
                          (if (is-eq (/ (get value temp-tuple) u100) u10)
                            (list id id id id id id id id id id)
                            (if (is-eq (/ (get value temp-tuple) u100) u11)
                              (list id id id id id id id id id id id)
                              (if (is-eq (/ (get value temp-tuple) u100) u12)
                                (list id id id id id id id id id id id id)
                                (if (is-eq (/ (get value temp-tuple) u100) u13)
                                  (list id id id id id id id id id id id id id)
                                  (if (is-eq (/ (get value temp-tuple) u100) u14)
                                    (list id id id id id id id id id id id id id id)
                                    (if (is-eq (/ (get value temp-tuple) u100) u15)
                                      (list id id id id id id id id id id id id id id id)
                                      (if (is-eq (/ (get value temp-tuple) u100) u16)
                                        (list id id id id id id id id id id id id id id id id)
                                        (if (is-eq (/ (get value temp-tuple) u100) u17)
                                          (list id id id id id id id id id id id id id id id id id)
                                          (if (is-eq (/ (get value temp-tuple) u100) u18)
                                            (list id id id id id id id id id id id id id id id id id id)
                                            (if (is-eq (/ (get value temp-tuple) u100) u19)
...
(define-public (deposit-stacks (amount uint) (address (optional (tuple (hashbytes (buff 20)) (version (buff 1))))) )
  (begin 
    (asserts! (is-eq (mod amount u100) u0) NOT_VALID_AMOUNT)
    (asserts! (<= amount u2000) NOT_VALID_AMOUNT)
    (asserts! (is-eq (var-get is-locked) false) CONTRACT_IS_LOCKED)
    ...
    (if (is-some (map-get? stx-to-btc { stx-address: tx-sender }))
      (begin 
        (asserts! (<= (+ (get value (unwrap-panic (map-get? id-to-participant (unwrap-panic (map-get? participant-to-id tx-sender))))) amount) u2000) NOT_VALID_AMOUNT)
